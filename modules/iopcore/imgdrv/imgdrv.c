...
iop_device_ops_t my_device_ops =
    {
        IOMAN_RETURN_VALUE(1),       // init
        IOMAN_RETURN_VALUE(1),       // deinit
        IOMAN_RETURN_VALUE(ENOTSUP), // dummy_fs,// format
        IOMAN_RETURN_VALUE(1),       // open_fs,// open
        close_fs,                    // close
        read_fs,                     // read
        IOMAN_RETURN_VALUE(ENOTSUP), // dummy_fs,// write
        lseek_fs,                    // lseek
                                     /*
                           dummy_fs, // ioctl
                           dummy_fs, // remove
